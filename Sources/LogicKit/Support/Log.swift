...
public enum Log {
    ...
    public static func log(_ level: Level, _ message: String, subsystem: String = "main", file: String = #file, line: Int = #line) {
    ...
    public static func debug(_ msg: String, subsystem: String = "main", file: String = #file, line: Int = #line) {
        log(.debug, msg, subsystem: subsystem, file: file, line: line)
    }

    public static func info(_ msg: String, subsystem: String = "main", file: String = #file, line: Int = #line) {
        log(.info, msg, subsystem: subsystem, file: file, line: line)
    }

    public static func warn(_ msg: String, subsystem: String = "main", file: String = #file, line: Int = #line) {
        log(.warn, msg, subsystem: subsystem, file: file, line: line)
    }

    public static func error(_ msg: String, subsystem: String = "main", file: String = #file, line: Int = #line) {
