...
- [ ] Task 1 — Таргет LogicKit рядом со старым кодом. Выполни раздел «### Task 1» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 2 — AXNode, фикстуры и поиск по дереву. Выполни раздел «### Task 2» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 3 — Живой AX, счётчик сообщений, LogicApp, live-таргет. Выполни раздел «### Task 3» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 4 — logic-ax-dump. Выполни раздел «### Task 4» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 5 — WindowSnapshot. Выполни раздел «### Task 5» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 6 — AXExecutor. Выполни раздел «### Task 6» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 7 — logic-probe, локатор, меню-пути, копии проектов. Выполни раздел «### Task 7» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть. [👤 частично: шаг 8 — копия проекта пользователя] Если живой Logic с fixture- проектом недоступен — сделай всё офлайн и ответь BLOCKED по live-части, не подделывая результат.
...
- [ ] Task 17 — Ошибки, исходы, оценка токенов. Выполни раздел «### Task 17» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 18 — Значения в единицах Logic. Выполни раздел «### Task 18» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 19 — Пути. Выполни раздел «### Task 19» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 20 — LocaleTable. Выполни раздел «### Task 20» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 21 — Модель и ридеры. Выполни раздел «### Task 21» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 22 — Хэндлы. Выполни раздел «### Task 22» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 23 — Резолвер. Выполни раздел «### Task 23» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
- [ ] Task 24 — Рендер и бюджеты токенов. Выполни раздел «### Task 24» из requirements.md (ниже в этом файле) целиком и по порядку: Files/Interfaces — контракт, шаги — TDD с указанными командами; Expected должен совпасть.
